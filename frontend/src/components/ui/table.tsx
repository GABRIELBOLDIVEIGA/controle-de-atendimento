...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-t-black font-base [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border text-text dark:border-darkBorder transition-colors dark:bg-darkText bg-background font-base data-[state=selected]:bg-white",
      className
    )}
    {...props}
  />
